package com.tocgroup.select;

import com.tocgroup.helper.Validate;
import com.tocgroup.nodes.Comment;
import com.tocgroup.nodes.Document;
import com.tocgroup.nodes.DocumentType;
import com.tocgroup.nodes.Element;
import com.tocgroup.nodes.Node;
import com.tocgroup.nodes.XmlDeclaration;
...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<com.tocgroup.nodes.Attribute> values = element.attributes().asList();
            for (com.tocgroup.nodes.Attribute attribute : values) {
