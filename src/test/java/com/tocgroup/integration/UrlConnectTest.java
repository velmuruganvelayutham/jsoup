package com.tocgroup.integration;

import org.junit.Ignore;
import org.junit.Test;
import org.tocgroup.Connection;
import org.tocgroup.HttpStatusException;
import org.tocgroup.Jsoup;
import org.tocgroup.UnsupportedMimeTypeException;
...
public class UrlConnectTest {
    ...
    public void exceptOnUnknownContentType() {
        ...
        try {
            ...
            threw = true;
            assertEquals("com.tocgroup.UnsupportedMimeTypeException: Unhandled content type. Must be text/*, application/xml, or application/xhtml+xml. Mimetype=image/png, URL=http://jsoup.org/rez/osi_logo.png", e.toString());
    ...
    public void throwsExceptionOnError() {
        ...
        try {
            ...
            threw = true;
            assertEquals("com.tocgroup.HttpStatusException: HTTP error fetching URL. Status=404, URL=http://direct.infohound.net/tools/404", e.toString());
            assertEquals(url, e.getUrl());
